...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<CryptoTemplate> currencyModalArrayList;
    private GetCurrency currencyRVAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currencyRVAdapter = new GetCurrency(currencyModalArrayList, this);
    ...
    private void filter(String filter) {
        ...
        ArrayList<CryptoTemplate> filteredlist = new ArrayList<>();
        // running a for loop to search the data from our array list.
        for (CryptoTemplate item : currencyModalArrayList) {
    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        currencyModalArrayList.add(new CryptoTemplate(name, symbol, price));
                    }
            ...
            public Map<String, String> getHeaders() {
                ...
                headers.put("X-CMC_PRO_API_KEY", "982c2cf2-dc07-4958-86d9-4fb3bd37ada9");
                return headers;
            }
        };
